...
/*
*  properthive_home_reports_update
*
...
class properthive_home_reports_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://wp-property-hive.com/add-on-store/propertyhive-home-reports-g65fvo87/update-info.php',
...
if( is_admin() )
{
	new properthive_home_reports_update();
}
